...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/styles/newMessage.css'/>">
</head>
<body>
	<div class="top-bar">
    ...
    <div class="container">
        ...
        <form action="/Polovni/user/sendMessage" method="post" class="message-form">
            <input type="hidden" name="idSender" value="${user.idUser}" />
            <input type="hidden" name="idReceiver" value="${seller.idUser}" />

            <label for="message">Poruka:</label><br>
            <textarea id="message" name="text" placeholder="Unesite tekst poruke..."></textarea><br><br>
